...
public class ItemBuilder {
    ...
    private void setMaterial() {
        ...
        if (material == null) {
            ...
            Bukkit.getLogger().warning("Error while creating item: " + section.getNameAsString()
                    + ". Invalid material. Defaulting to RED_BANNER");
            return;
    ...
    private void setColor() {
        ...
        leatherArmorMeta
                .setColor(Color.fromRGB(Integer.parseInt(rgb[0]), Integer.parseInt(rgb[1]), Integer.parseInt(rgb[2])));
